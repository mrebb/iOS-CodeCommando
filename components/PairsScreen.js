...
export class PairsScreen extends React.Component {
  ...
  render() {
    if(this.props.day && this.props.classCode){
    return (
      (this.state.studentPairs.length > 0 && this.state.isLoading!==true)?
        <Wallpaper>
          <View >
            <FlatList
          ...
          </Wallpaper>:<Wallpaper><ActivityIndicator style={styles.activityIndicator} color="#FA1111" size="large" /></Wallpaper>
